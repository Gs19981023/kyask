...
/*测试title*/
Route::get('/test',['as'=>'website.test','uses'=>'IndexController@test']);


/*资料resource*/
Route::get('/resource',['as'=>'website.resource','uses'=>'IndexController@resource']);

/*院校school*/
Route::get('school',['as'=>'website.school','uses'=>'IndexController@school']);
