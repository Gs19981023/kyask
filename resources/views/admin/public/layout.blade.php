...
<head>
    ...
    <title>@yield('title') - 考研信息网管理后台</title>
    <!-- Bootstrap 3.3.2 -->
...
<div class="wrapper">
    <header class="main-header">
        ...
        <div class="logo">
            ...
            <span class="logo-mini"><b>KY</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg text-center">
                <!-- <a class="navbar-brand admin_logo" href="{{ route('admin.index.index') }}"></a> 
                -->
                <a href="http://www.tp.com:82/index.php" style="text-decoration: none"><font color=#fff><b>考研信息交流网</b></font></a>
            </span>
