...
@section('jumbotron')
    ...
    <div class="jumbotron text-center">
        <h4>{{ Setting()->get('website_welcome','现在加入503实验室，一起进入技术的世界') }} <a class="btn btn-primary ml-10" href="{{route('auth.user.register') }}" role="button">立即注册</a> <a class="btn btn-default ml-5" href="{{ route('auth.user.login') }}" role="button">用户登录</a></h4>
    </div>
    @endif
@endsection
    ...
    <div class="row mt-10">
        <div class="col-xs-12 col-md-9 main">
                    ...
                    <div class="col-md-6">
                        <div id="carousel-recommendation" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#carousel-recommendation" data-slide-to="1">哈哈哈啊</li>
            ...
            <div class="widget-box">
                <div class="job-list-item row">
                    <div class="col-md-6">
                        <h4 class="widget-box-title">今日推荐 <a href="{{ route('website.blog',['category_slug'=>'all','filter'=>'hottest']) }}" title="更多">»</a></h4>
                        <ul class="widget-links list-unstyled">
