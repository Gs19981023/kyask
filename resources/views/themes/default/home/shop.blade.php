...
@section('seo_title')荣誉 @if($goods->currentPage()>1)- 第{{ $goods->currentPage() }}页@endif - {{ Setting()->get('website_name') }}@endsection


@section('content')
    <h1 class="h3">荣誉<br><small></small></h1>
    <div class="row  mt-20">
        <div class="col-xs-12 col-md-9 main">
            ...
            <section class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <!--     <p class="text-center"><span class="text-gold"><i class="fa fa-database"></i> {{ $good->coins }} 金币</span>
                        	<span class="text-muted ml-10">剩余 {{ $good->remnants }} 个</span></p>
