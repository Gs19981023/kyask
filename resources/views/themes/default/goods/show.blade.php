...
@section('seo_title'){{ $goods->name }} - 获奖详情 - {{ Setting()->get('website_name') }}@endsection
    ...
    <div class="row mt-20">
        <div class="col-xs-12 col-md-9 main">
            ...
            <div class="widget-box">
                <div class="widget-box-title">获奖详情</div>
                    ...
                    <div class="panel-group" id="accordion">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="post-attentions" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>填写真实有效的邮寄地址、邮编、收件人、联系电话和email地址，并保持电话畅通，这样能准确地签收获奖。请妥善保护自己的账号和密码，以免泄露个人信息。</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="receive-time" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>兑换成功后，知识商城的工作人员将在15日内将您的获奖寄出，快递到达时间视情况而定，一般在1-2周之内。</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
